...
VIOLATION_CODES = types.MappingProxyType({
    ...
    107: 'The option `--type-hints-in-signature` is `False` but there are type hints in the signature',
    108: 'The option `--type-hints-in-docstring` is `True` but there are no type hints in the docstring arg list',
    109: 'The option `--type-hints-in-docstring` is `False` but there are type hints in the docstring arg list',
